...
>*${mon.level ? `${Parser.getOrdinalForm(mon.level)}-level ` : ""}${Parser.sizeAbvToFull(mon.size)} ${monTypes.asText}${mon.matterenergy ? `, ${Parser.matterenergyListToFull(mon.matterenergy)}` : ""}*
>___
>- **Armor Class** ${acPart}
