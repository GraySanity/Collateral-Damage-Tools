class RenderBestiary {
	...
	static _$getRenderedCreature (mon, options, renderer) {
		...
		<tr><td colspan="6">
			<div ${hasToken ? `class="mon__wrp-size-type-align--token"` : ""}><i>${Renderer.monster.getTypeMatterenergyPart(mon)}</i></div>
		</td></tr>
		...
		<tr><td colspan="6"><div ${hasToken ? `class="mon__wrp-avoid-token"` : ""}><strong>Damage Reduction</strong> ${Parser.drToFull(mon.dr)}</div></td></tr>
